...
export function UilForecastcloudMoonTear(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="36px" height="36px" viewBox="0 0 24 24" {...props}>
      {' '}
      <path
        fill="currentColor"
        d="M21.7 7.57a1 1 0 0 0-.93-.26a3.2 3.2 0 0 1-.66.08a3 3 0 0 1-3-3a3 3 0 0 1 .08-.65A1 1 0 0 0 16 2.53a4.93 4.93 0 0 0-3.83 4.21a6.24 6.24 0 0 0-1.67-.24a6 6 0 0 0-5.94 5.13a3.5 3.5 0 0 0-.46 6.58a1.14 1.14 0 0 0 .4.08a1 1 0 0 0 .4-1.92A1.48 1.48 0 0 1 4 15a1.5 1.5 0 0 1 1.5-1.5a1 1 0 0 0 1-1a4 4 0 0 1 4-4a3.92 3.92 0 0 1 2.18.66a4 4 0 0 1 1.57 2a1 1 0 0 0 .78.67a2.32 2.32 0 0 1 .97 4.28a1 1 0 0 0 1.1 1.68a4.32 4.32 0 0 0 1.9-3.62a4.23 4.23 0 0 0-.49-2A4.94 4.94 0 0 0 22 8.5a1 1 0 0 0-.3-.93Zm-4.59 2.82a2.61 2.61 0 0 1-.42 0A4.6 4.6 0 0 0 16 10a6 6 0 0 0-1.82-2.28v-.37a3 3 0 0 1 1.05-2.28a5 5 0 0 0 4.23 4.23a3 3 0 0 1-2.35 1.09Zm-6 3.94a1 1 0 0 0-1.12 0C9.84 14.41 7.5 16 7.5 18.5a3 3 0 0 0 6 0c0-2.5-2.35-4.1-2.44-4.17Zm-.61 5.17a1 1 0 0 1-1-1a3 3 0 0 1 1-2a3 3 0 0 1 1 2a1 1 0 0 1-1 1Z"
      >
        {' '}
      </path>
    </svg>
...
export function IonLogoReact(props: SVGProps<SVGSVGElement>) {
  return (
...
export function FileIconsStyledcomponents(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="3em" height="3em" viewBox="0 0 512 512" {...props}>
      <path
        fill="currentColor"
...
export function TeenyiconsNextjsOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="3em" height="3em" viewBox="0 0 15 15" {...props}>
      <path
        fill="currentColor"
...
export function TablerBrandTwitter(
...
export function DarkModeOutlineRounded(
  props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>
) {
  return (
    <svg width="24px" height="24px" viewBox="0 0 24 24" {...props}>
...
export function MaterialSymbolsAirplaneTicketOutline(
  ...
  return (
    <svg width="30px" height="30px" viewBox="0 0 24 24" {...props}>
      ...
      >
        ...
        <path d="M2.5 21h8l-4-7zM14 3l7 7m-7 0l7-7m-7 11h7v7h-7z"></path>
      </g>
    </svg>
  );
}
...
export function MdiTailwind(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="35px" height="35px" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function ShieldIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="30px" height="30px" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
        d="M12 22q-3.475-.875-5.737-3.988Q4 14.9 4 11.1V5l8-3l8 3v6.1q0 3.8-2.262 6.912Q15.475 21.125 12 22Zm0-2.1q2.6-.825 4.3-3.3q1.7-2.475 1.7-5.5V6.375l-6-2.25l-6 2.25V11.1q0 3.025 1.7 5.5t4.3 3.3Zm0-7.9Z"
      ></path>
    </svg>
  );
}
...
export function BxBxlTailwindCss(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="3.5em" height="3.5em" viewBox="0 0 24 24" {...props}>
      <path
...
export function MaterialSymbolsMovieFilterOutline(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg width="30px" height="30px" viewBox="0 0 24 24" {...props}>
...
export function MaterialSymbolsWidgetsOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="30px" height="30px" viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
        d="M16.65 13L11 7.35l5.65-5.65l5.65 5.65ZM3 11V3h8v8Zm10 10v-8h8v8ZM3 21v-8h8v8ZM5 9h4V5H5Zm11.675 1.2L19.5 7.375L16.675 4.55L13.85 7.375ZM15 19h4v-4h-4ZM5 19h4v-4H5ZM9 9Zm4.85-1.625ZM9 15Zm6 0Z"
      ></path>
    </svg>
  );
}
...
export function FluentThumbLike16Filled(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" {...props}>
      <path
        fill="currentColor"
