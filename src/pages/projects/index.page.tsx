...
import { Container, UpcomingProject, LinkProject, ContentCard, TextCard, ContainerLinksProjects } from "./styles"
        ...
        <Container>
            ...
            <UpcomingProject>
                <ContainerLinksProjects>
                    <LinkProject href="https://github.com/Gabriellopes232/portfolio-2.0" target='_blank'>
                        <ContentCard>
                            <GgWebsite />
                            <TextCard>
                                <h3>Website</h3>
                    ...
                    <LinkProject href="https://github.com/Gabriellopes232/forecast-api" target='_blank'>
                        <ContentCard>
                    ...
                    <LinkProject href="https://github.com/Gabriellopes232/mytrips" target='_blank'>
                        <ContentCard>
                ...
                <h4>Lastest</h4>
                <ContainerLinksProjects>
                    <LinkProject href="https://github.com/Gabriellopes232/datmoney" target='_blank'>
                        <ContentCard>
                    ...
                    <LinkProject href="https://github.com/Gabriellopes232/Prime-Flix" target='_blank'>
                        <ContentCard>
                ...
                <ContainerLinksProjects>
                    ...
                    <LinkProject href="https://css-tricks.com/tag/tailwind/" target='_blank'>
                        <ContentCard>
                            <MdiTailwind />
                            <TextCard>
                                <h3>Tailwind</h3>
